...
% include("head.tpl")
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>Om NextUP! Malmö</h2>
                    <p>I Malmö finns ett stort utbud av event spridda mellan många olika områden. För en person kan det vara lätt att idag missa stora delar av detta utbud eftersom det är svårt att få information om event som ligger utanför vanliga beteende-, rörelse- eller intresseområden. 
</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">The NextUP! team</h2>
            </div>
